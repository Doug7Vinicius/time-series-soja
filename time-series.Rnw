...
<<script1, message=FALSE, warning=FALSE, echo=FALSE, fig.cap="Indicador de preço da soja no período de outubro de 1997 até outubro de 2022 \\label{fig1}", fig.width=7,fig.height=4, fig.pos="H">>=
soja %>% 
...
<<script2, message=FALSE, warning=FALSE, echo=FALSE, fig.cap="", fig.height=4>>=
soja %>% 
...
<<script4, message=FALSE, warning=FALSE, echo=FALSE, fig.cap="", fig.height=4>>=
soja %>% 
...
<<script5, message=FALSE, warning=FALSE, echo=FALSE, fig.cap="", fig.height=4>>=
SJdif <- diff(soja) 
autoplot(SJdif, xlab = "Tempo", ylab = "Valor (Reais por saca de 60 kg)", ts.colour = 'blue')
@


<<script6, message=FALSE, warning=FALSE, echo=FALSE, fig.cap="", fig.height=4>>=
SJlog <- log(soja) 
autoplot(SJlog, xlab = "Tempo", ylab = "Valor (Reais por saca de 60 kg)", ts.colour = 'blue')
@
