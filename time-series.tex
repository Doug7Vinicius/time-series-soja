...
\begin{alltt}
\hlkwd{library}\hlstd{(forecast)}   \hlcom{#}
\hlkwd{library}\hlstd{(timeSeries)} \hlcom{#}
\hlkwd{library}\hlstd{(urca)}       \hlcom{#}
\hlkwd{library}\hlstd{(randtests)}  \hlcom{#}
\hlkwd{library}\hlstd{(tseries)}    \hlcom{#}
\hlkwd{library}\hlstd{(stats)}      \hlcom{#}
\hlkwd{library}\hlstd{(readxl)}     \hlcom{#}
\hlkwd{library}\hlstd{(tidyverse)}  \hlcom{#}

\hlstd{soja} \hlkwb{<-} \hlkwd{read_xls}\hlstd{(}\hlstr{"...dataset/soja.xls"}\hlstd{)} \hlcom{#}

\hlstd{soja} \hlkwb{<-} \hlkwd{ts}\hlstd{(soja}\hlopt{$}\hlstd{Preço,} \hlkwc{start} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{1997}\hlstd{,}\hlnum{10}\hlstd{),} \hlkwc{frequency} \hlstd{=} \hlnum{12}\hlstd{)} \hlcom{#}

\hlkwd{class}\hlstd{(soja)} \hlcom{# }
\hlkwd{as.ts}\hlstd{(soja)} \hlcom{# }
